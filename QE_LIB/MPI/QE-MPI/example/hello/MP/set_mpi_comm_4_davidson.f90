...
!
!----------------------------------------------------------------------------
SUBROUTINE set_mpi_comm_4_davidson(parent_comm, intra_bgrp_comm_, inter_bgrp_comm_ )
  !----------------------------------------------------------------------------
  !
  USE kinds,             ONLY : DP
  USE mp_bands_util
  ...
  !
    ...
    RETURN
  !
END SUBROUTINE set_mpi_comm_4_davidson
!----------------------------------------------------------------------------
SUBROUTINE unset_mpi_comm_4_davidson()
  !----------------------------------------------------------------------------
  !
  use mp_diag
  IMPLICIT NONE
  ...
  CALL clean_ortho_group ( )
    ...
    RETURN
  !
END SUBROUTINE unset_mpi_comm_4_davidson
